            ...
            <Container>
                <Grid container spacing={3} sx={{ my: 3 }}>
                    <Grid item xs={12} sm={12} md={6} lg={3}>
                        <List sx={{ mt: 4 }}>
                            <ListItemText>Emergency Service Care</ListItemText>
                            <ListItemText>Check Up</ListItemText>
                            <ListItemText>Village of Personal Computer</ListItemText>
                            <ListItemText>Laptop Extraction</ListItemText>
                            <ListItemText>Check Up</ListItemText>
                        </List>
                    </Grid>
                    <Grid item xs={12} sm={12} md={6} lg={3}>
                        <List>
                            <ListItemText sx={{ color: '#19D3AE', mb: 1 }}> All Services</ListItemText>
                            <ListItemText >Emergency Service Care</ListItemText>
                            <ListItemText>Check Up</ListItemText>
                            <ListItemText>Village of Personal Take Care</ListItemText>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={3}>
                        <List>
                            <ListItemText sx={{ color: '#19D3AE', mb: 1 }}>Oral Computer</ListItemText>
                            <ListItemText>Emergency Service Care</ListItemText>
                            <ListItemText>Check Up</ListItemText>
                            <ListItemText>Treatment of Personal Computer</ListItemText>
                            <ListItemText>Tooth Extraction</ListItemText>
                            <ListItemText>Check Up</ListItemText>
                            <ListItemText>Check Up</ListItemText>
                            <ListItemText>Check Up</ListItemText>
